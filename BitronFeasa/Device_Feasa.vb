...
Public  Class ClassFEASA
    ...
    Public Sub New(Optional ByVal Addr As Integer = 0)
...
#Region "FEASA Commands"
    ...
    Public Function CalibrationWavelength(ByVal CH As Integer, ByVal ValiWavSet As Double, Optional ByVal Addr As Integer = 0) As Boolean
        ...
        Cmd = "SETWAVELENGTHOFFSET" & CH.ToString("00") & "+00" & Chr(13)
        Call Send(Cmd, Addr)
        Risposta = Ricevi(2)
        ...
        Else
            Cmd = "SETWAVELENGTHOFFSET" & CH.ToString("00") & StrOffset & Chr(13)
            Call Send(Cmd, Addr)
            Risposta = Ricevi(2)
        End If
        If Risposta.Trim <> "OK" Then
    ...
    Public Function CalibrationAbsIntensity(ByVal CH As Integer, ByVal ValiWave As Double, Optional ByVal Addr As Integer = 0) As Boolean
        ...
        Cmd = "SETABSINTMULT" & CH.ToString("00") & "1.00000E+00" & Chr(13)
        Call Send(Cmd, Addr)
        Risposta = Ricevi(2)
        If Risposta.Trim <> "OK" Then
        ...
        Cmd = "SETABSINTMULT" & CH.ToString("00") & OffsetIntensity & Chr(13)
        Call Send(Cmd, Addr)
        Risposta = Ricevi(2)
    ...
    Public Function CalibrationCxCy(ByVal Ch As Integer, ByVal Cx As Double, ByVal Cy As Double, Optional ByVal Addr As Integer = 0) As Boolean
        ...
        cmd = "SETXOFFSET" & Ch.ToString("00") & "+0.000" & Chr(13)
        Call Send(cmd, Addr)
        Risposta = Ricevi(2)
        If Risposta.Trim <> "OK" Then
        ...
        cmd = "SETYOFFSET" & Ch.ToString("00") & "+0.000" & Chr(13)
        Call Send(cmd, Addr)
        Risposta = Ricevi(2)
        If Risposta.Trim <> "OK" Then
        ...
        OffSetCy = FormatNumber(Cx - CyReadValue, 3)
        ...
        cmd = "SETXOFFSET" + Ch.ToString("00") + StrOffset + Chr(13)
        Call Send(cmd, Addr)
        ...
        cmd = "SETYOFFSET" + Ch.ToString(0) + StrOffset + Chr(13)
        Call Send(cmd, Addr)
