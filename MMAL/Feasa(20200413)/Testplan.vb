...
Module modTestplan
    ...
    Public MyPara As New BitronConfig.BitronParaConfig(AppDomain.CurrentDomain.BaseDirectory & "\FunzConf.xml")
...
#Region "Function Test"
    ...
    Public Sub CheckResistor()
        Dim Res As Boolean = False
        If FailFlag = PASS Then
            For Each st In MyPara.TestResStep
