                ...
                For Each stp In Ver.Sites        'Select Site Steps
                    If stp.SiteNo = SiteNo Then
                        For Each j In stp.SITE
                            ...
                            If SiteNo = 2 And j.LEDName = "DL18" Then
                                MsgBox(CurrentIndex & " " & Ch & " " & FeasaCollectList(CurrentIndex).AbsI(Ch))
                            End If
