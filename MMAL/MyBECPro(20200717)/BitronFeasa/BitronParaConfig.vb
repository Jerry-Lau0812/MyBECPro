                ...
                For Each PreNode As XmlNode In RootNode
                    ...
                    For Each SubNode As XmlNode In PreNode
                        Select Case SubNode.Name
                            ...
                            Case "RESISTOR_OHM_S"
                                cRes.RESISTOR_S = SubNode.InnerText
                        End Select
                    Next
                    mLEDRES.Add(cRes)
                Next
                ...
                For Each PreNode As XmlNode In RootNode
                    ...
                    For Each SubNode In PreNode
                        Select Case SubNode.Name
                            ...
                            Case "Combination"
                                cResStep.Combination = SubNode.InnerText
                            Case "Modulux"
