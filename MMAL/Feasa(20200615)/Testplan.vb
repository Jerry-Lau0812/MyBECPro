...
#Region "Check Resistor"
    ...
    Public Function GetCoeA(ByVal RawData As String) As Double
        Dim A As Double
        Dim Nums() As String = Regex.Split(RawData, "\D+")
            ...
            Try
                ...
                If xx.Count > 0 Then
                    ...
                    If xx(0).RESISTOR_H.ToString().Contains("%") Then
                        SRes_H = Val(xx(0).RESISTOR_S) * Val(xx(0).RESISTOR_H.ToString.Trim("%") / 100)
                    Else
                        SRes_H = Val(xx(0).RESISTOR_H)
                    End If
                    If xx(0).RESISTOR_L.ToString().Contains("%") Then
                        SRes_L = Val(xx(0).RESISTOR_S) * Val(xx(0).RESISTOR_L.ToString.Trim("%") / 100)
                    Else
            ...
            Try
                ...
                If xx.Count > 0 Then
                    ...
                    If xx(0).T_H.ToString().Contains("%") Then
                        SCur_H = Val(xx(0).T_S) * Val(xx(0).T_H.ToString.Trim("%") / 100)
                    Else
                        SCur_H = Val(xx(0).T_H)
                    End If

                    If xx(0).T_L.ToString().Contains("%") Then
                        SCur_L = Val(xx(0).T_S) * Val(xx(0).T_L.ToString.Trim("%") / 100)
                    Else
                        SCur_L = Val(xx(0).T_L)
                    End If
