...
#Region "Function Test"
        ...
        If FailFlag = PASS Then
            If Myconf.GENERAL.GetBinCodeFromFujiTrax = "1" Then
                ...
                If TraxResult.Count > 0 Then
                    FailFlag = PASS
                    MsgPrintLog("Get DataMatrix From FujiTrax PASS " & NumSite, 0)
                Else
                    FailFlag = FAIL
                    MsgPrintLog("Get DataMatrix From FujiTrax FAIL " & NumSite, 0)
                End If
            Else
                FailFlag = PASS
            End If
    ...
    Public Sub LightAllLED()
        If FailFlag = PASS Then
            Try
                Dim Meas As Integer = RunAnlTaskLabel("", "POWERON", "POWERON")
                If Meas = PASS Then
    ...
    Public Sub CloseAllLED()
        'If FailFlag = PASS Then
        Try
            Dim Meas As Integer = RunAnlTaskLabel("", "POWEROFF", "POWEROFF")
            If Meas = PASS Then
    ...
    Public Sub CheckCalibrationFeasa(ByVal BayNo As Integer, ByVal SiteNo As Integer, ByVal ProgNo As String, ByVal PCBMatrix As String)
        ...
        If My.Computer.FileSystem.FileExists(AppDomain.CurrentDomain.BaseDirectory + "\MMAL\MatrixUUT" + NumSite.ToString + ".txt") = True Then
            ...
            CaliMatrix = CaliMatrix.Substring(0, 20)
        End If
            ...
            Try
                ...
                If xx.Count > 0 Then
                    If xx(0).T_H > TerminalRes And xx(0).T_L < TerminalRes Then
                        PrintResultCurMsg(PASS, NumSite, BinName, TerminalRes, xx(0).T_H.ToString, xx(0).T_L.ToString, " mA")
                        Res = True
                    Else
                        PrintResultCurMsg(FAIL, NumSite, BinName, TerminalRes, xx(0).T_H.ToString, xx(0).T_L.ToString, " mA")
                        Res = False
                    End If
                End If
                If Res Then
