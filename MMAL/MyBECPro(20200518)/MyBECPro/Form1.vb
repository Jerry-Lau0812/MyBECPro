...
Public Class Form1
    ...
    Private Sub Btn_Validate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_Validate.Click
        ...
        Dim CodeBitron = "30100646_30100647" 'Suport use CodeBitron 30100646
                        ...
                        For Each j In stp.SITE
                            ...
                            For Each FeasaCollect In FeasaCollectList
                                If FeasaCollect.FeasaName = j.Name Then
                                    ...
                                    HoldRegisterRead(j.VFRegister, TempRegisterVF, "")
                                    ValidateVF(j.Name, SiteNo, j.BinName, j.Code, TempRegisterVF, j.VFOffset)
                                    ValidateHSI(j.LEDName, SiteNo, j.BinName, j.Code, FeasaCollect.H(Ch), FeasaCollect.S(Ch), FeasaCollect.I(Ch), j.HueOffset, j.SatOffset, j.IntensityOffset)
                                    ValidateAbsIntensity(j.LEDName, SiteNo, j.BinName, j.Code, FeasaCollect.AbsI(Ch), j.IntensityOffset)
                                    ValidateWavelength(j.LEDName, SiteNo, j.BinName, j.Code, FeasaCollect.Wave(Ch), j.DominantWavOffset)
                                    ValidateCXCY(j.LEDName, SiteNo, j.BinName, j.Code, FeasaCollect.Cx(Ch), FeasaCollect.Cy(Ch), j.CxOffset, j.CyOffset)
                                End If
                            Next
