...
#Region "Function Test"
    ...
    Public Sub FeasaCalibrationAbsIntensity(ByVal FeasaName As String, ByVal Ch As Integer, ByVal ValiAbsint As Double)
        Dim Res As Boolean = False
        If FailFlag = PASS Then
            ...
            End If
            Res = SystemOperate.Device_FEASA.CalibrationAbsIntensity(Ch, ValiAbsint)
        Else
            Res = False
        End If
