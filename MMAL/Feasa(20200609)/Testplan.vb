...
#Region "Function Test"
    ...
    Public Sub LightONLED(Optional ByVal TaskLabel As String = "POWERON")
        If FailFlag = PASS Then
            Try
                ...
                Res = RunAnlTaskLabel("", TaskLabel, TaskLabel)
                If Res Then
                    Threading.Thread.Sleep(200)
                    MsgPrintLog("Light " & TaskLabel & " Success:" & NumSite & " " & ProgNo, 0)
                    FailFlag = PASS
                Else
                    MsgPrintLog("Light " & TaskLabel & " Failed:" & NumSite & " " & ProgNo, 0)
                    FailFlag = FAIL
                End If
            Catch
                FailFlag = FAIL
    ...
    Public Sub LightOFFLED(Optional ByVal TaskLabel As String = "POWEROFF")
        Try
            Dim Res As Boolean = RunAnlTaskLabel("", TaskLabel, TaskLabel)
            If Res Then
    ...
    Public Function GetAllFeasaPara(ByVal FeasaObj As String, ByRef ChNum As Integer, ByRef H() As Double, ByRef S() As Integer, ByRef I() As Integer, ByRef AbsInt() As Double, ByRef Wave() As Integer, ByRef Cx() As Double, ByRef Cy() As Double)
        ...
        Res = SystemOperate.Device_FEASA.GetAbsoluIntensity(ChNum, AbsInt, ClassFEASA.EBrightLevel.Auto)
