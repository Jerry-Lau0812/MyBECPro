...
Public Class BitronConfig
    ...
    Public Sub New(Optional ByVal StrXmlPath As String = "\FunzConf.XML")
        CLog4Net.Logs4Net(CLog4Net.LogLevel._Info, "Loading FunzConf.xml...")
    ...
    Public Sub InitialAllInfo()
        Try
            CLog4Net.Logs4Net(CLog4Net.LogLevel._Info, "Loading Parameter Begin...")
            LoadGeneralPara()
            LoadHardwarePara()
            LoadLEDPara()
            LoadVESIONI()
    ...
    Public Sub LoadGeneralPara()
        Try
            ...
            With myGeneral
                ...
                Try
                    .EnableLog = CType(myXml.RicercaXML("GENERAL", "EnableLog"), String)
                Catch ex As Exception
                    'Do nothing
                End Try
